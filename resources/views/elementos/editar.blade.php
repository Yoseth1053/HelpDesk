            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                @csrf
                 ...
                 <div class="card-header" style="justify-content: center; background-color:#33A2C5; color:white;">
                        <h1 style="text-align: center;"><i class="fas fa-laptop-house"></i><b><font face="nirvana">Editar Elemento</font></b></h1>
                 </div>
                 <br>
                      ...
                      <div class="row" style="justify-content: center;">
                        ...
                        <div class="col-3">
                          <div class="form-group" style="text-align: center;">
                            ...
                            <input class="form-control" value="{{$elemento->nombre}}" type="text" name="nombre" id="nombre" placeholder="Ingrese Un Nombre" required>
                          </div>
                        </div>
                        <hr>
                        <br>
                        <div class="row" style="justify-content: center;">
                          <div class="col-3" style="text-align: center;" >
                            <a href="{{ route('elementos.index') }}" style="background-color: #BC2B2B; color:white"  class="btn"> Volver</button> </a>
                          </div>
