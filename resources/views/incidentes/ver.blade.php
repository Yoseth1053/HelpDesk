        ...
        <div class="max-w-7x1 mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-x1 sm:rounded-lg">
                <div class = "block">
                    ...
                    <x-jet-label for="id_elemento" value="{{ __('Elemento')}}"/>
                    <x-jet-input id="id_elemento" class="block mt-1 w-full" type="text" name="id_elemento" :value="old('id_elemento', $inventarios->nombre)" required disabled />
